...
if (isset($_POST['submit'])) { 
  ...
  $user->Chk_Login($username,$password);
}
...
<?php show_msg(); ?>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="" method="post">
        <h2 class="form-signin-heading">DB Scholars</h2>
...
<!--     <div class="panel-body">
     ...
     <table border="0" cellspacing="10" cellpadding="10"><tr><td>
      ...
      <input name="sample-radio" id="radio-01" value="student" type="radio" onChange="changeWindow(this.value)" />Student</label></td>
      <td>      
      <label class="label_radio" for="radio-02">
      <input name="sample-radio" id="radio-02" value="employee" type="radio" checked onChange="changeWindow(this.value)" />Staff</label>
      </td></tr></table>
   </div>
   </div>-->
