...
if(isset($_GET['std'])) {
	$id = $_GET['std'];
	$query = mysql_query("SELECT * FROM student_info WHERE `student_id`='$id'") or die(mysql_error());
          ...
          <section class="wrapper">
              <!-- page start-->
                      ...
                      <section class="panel">
                       ...
                       <tr>
              <td colspan="6" align="center"><img src="img/students/<?php echo $row['student_image']; ?>" width="200" height="200" /></td>
                       </tr>
                       ...
                       <tr>
                       <td><b>NATIONALITY</b></td> <td><?php echo $row['nat_id']; ?></td>
                       <td><b>RELIGION</b></td> <td><?php echo $row['rel_id']; ?></td>
                       ...
                       <tr>
                       <td><b>STUDENT ADDRESS</b></td> <td><?php echo $row['student_address']; ?></td>
                       <td><b>FORM NO.</b></td> <td><?php echo $row['form_no']; ?></td>
                       <td><b>REGISTRATION NO.</b></td> <td><?php echo $row['reg_no']; ?></td>
                       </tr>
