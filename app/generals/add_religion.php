<?php
if(isset($_POST['add-rel'])) {
	$general->AddReligion();
}
if(isset($_POST['edit-rel'])) {
	$id = $_POST['id'];
	$general->EditReligion($id);
}
          ...
          <section class="wrapper">
              <!-- page start-->
                      ...
                      <section class="panel">
                       ...
                       <a class="btn btn-warning" data-toggle="modal" href="#myModal2">Add Religion</a>
                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                              ...
                                              Are you sure to add new Religion?

                                          </div>
                                          <div class="modal-footer">
                             <button data-dismiss="modal" class="btn btn-default" type="button">Close</button>
                             <button class="btn btn-warning" type="submit" name="add-rel"> Confirm</button>
                                          </div>
                                      </div>
                                  </div>
                              </div>
...
<script>
 function editreligion(id){
  $.post("files/edit_rel.php/", {id: id}, function(page_response)
  {
