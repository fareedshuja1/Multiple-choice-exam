...
<a href="backup.php" onclick="confirminsert();">		
<img src="backup.png" alt="backup" title="BACKUP DATABASE" />
</a>
</div>
<br /><br /><br />
...
while (false !== ($file = readdir($dir))) { 
	...
	// Print the cells
		...
		echo "<td>"."<a target='_blank' href='./DB_backup/" . $filenameboth . ".sql'>Download SQL File</a>"."</td>";
		echo "</tr>";
	} 
} 
?> 
